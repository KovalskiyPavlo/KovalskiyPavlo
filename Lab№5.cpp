...
public:
	...
	{
		output << this->currentPageAdress << endl;
		output << this->PageHeight << endl;
		output << this->PageWidth << endl;
		output << this->downloadSpeed << endl;
		output << this->outloadSpeed << endl;
		return output;
	}

	CBrowser& operator= (CBrowser& b)
	{
		this->currentPageAdress = b.currentPageAdress;
		this->PageHeight = b.PageHeight;
		this->PageWidth = b.PageWidth;
		this->downloadSpeed = b.downloadSpeed;
		this->outloadSpeed = b.outloadSpeed;
		return *this;
	}

	CBrowser& operator+= (CBrowser& b)
	{
		this->downloadSpeed = this->downloadSpeed + b.downloadSpeed;
		this->outloadSpeed = this->outloadSpeed + b.outloadSpeed;
		return *this;
	}
	CBrowser& operator-= (CBrowser& b)
	{
	...
	const bool operator>(CBrowser& b)
	{
		if (this->downloadSpeed + this->outloadSpeed > b.downloadSpeed + b.outloadSpeed)
		{
			return 1;
		}
		return 0;
...
void Start()
{
	...
	*browser1 -= *browser2;
	...
	cout << "\nOverload > : " << endl;
	a = browser1 > browser2;
	cout << "browser1 speed > browser2 speed? = " << a << endl;
